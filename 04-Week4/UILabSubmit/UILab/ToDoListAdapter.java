...
import course.labs.uilab.ToDoItem.Status;
...
public class ToDoListAdapter extends BaseAdapter {
    ...
    // Remember to check whether convertView holds an already allocated View before created a new View.
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // TODO - Must also set up an OnCheckedChangeListener, which is called when the user toggles the status checkbox
