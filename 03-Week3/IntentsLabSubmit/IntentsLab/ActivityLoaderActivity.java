package course.labs.activityloaderactivity;
...
//        // (HINT: Use the Intent class' createChooser() method)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // TODO - Process the result only if this method received both a RESULT_OK result code and a recognized request code.
